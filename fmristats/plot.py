...
Some handy functions for plotting fMRI images and effect fields.
"""
...
def shift_colour_map(cmap, start=0, midpoint=0.5, stop=1.0, name='shiftedcmap'):
    '''
    Shift a colour map
    ...
    ----------
      ...
      midpoint : float
          ...
          you want the centre of the colormap at 0.0, `midpoint`
